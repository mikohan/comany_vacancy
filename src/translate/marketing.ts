...
export const marketing: IItem = {
  ...
  russian: {
    ...
    text: `<p>Я работаю в сфере интернет-маркетинга с 2002 года.
            Хорошему веб-разработчику абсолютно необходимы маркетинговые знания.
            Если вы собираетесь зарабатывать деньги на своем веб-проекте, еще до того, как вы начнете его разрабатывать, вы должны сначала разработать маркетинговую стратегию.
            Маркетинговая стратегия влияет на все в веб-проекте.
            Какую технологию использовать, какой фреймворк, какая должна быть логика.
            Сколько времени займет сдача проекта и сколько это будет стоить.
            ...
            и т.п.</p>
            <p>Потому что я хорошо разбираюсь в интернет-маркетинге, мои веб-проекты в большинстве случаев удавались.
            показатели эффективности одного из моих последних проектов вы можете найти ниже.
Всего хорошего, пока.</p>`,
  },
  czech: {
    header: 'Online Marketing Experience',
    text: `<p>V online marketingu pracuji méně či více od roku 2002.
            Marketingové znalosti jsou pro dobrého webového vývojáře naprosto nezbytné.
            </p>


            <p>Pokud máte v úmyslu vydělat peníze z vašeho webového projektu, musíte nejprve vytvořit marketingovou strategii.
            Marketingová strategie ovlivňuje vše ve webovém projektu.
            Jakou technologii použít, jaký rámec, jaká by měla být logika.
            Jak dlouho trvá dodání projektu a kolik to bude.
